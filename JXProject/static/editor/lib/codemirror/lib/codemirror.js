...
(function(mod) {
  ...
  // right), units can be "char", "column" (like char, but doesn't
  ...
  // any number of extending chars is treated as a single units as far
  ...
  // to move more than one units, in order to visually move one units.
